...
(136, 123, 'Mane & Tail', 1),
(137, 123, 'Iris', 2),
(138, 123, 'Cutie Mark', 3),
(139, 124, 'Coat', 0),
(140, 124, 'Mane & Tail', 1),
(141, 124, 'Iris', 2),
(142, 124, 'Cutie Mark', 3),
(143, 124, 'Scarf', 0),
(144, 125, 'Coat', 0),
(145, 125, 'Mane & Tail', 1),
(146, 125, 'Iris', 2),
(147, 125, 'Cutie Mark', 3),
(164, 138, 'Coat', 0),
(165, 138, 'Mane & Tail', 1),
(166, 138, 'Iris', 2),
(167, 138, 'Cutie Mark', 3),
(168, 138, 'Magic (100% Opacity)', 4),
(169, 139, 'Coat', 0),
(170, 139, 'Mane & Tail', 1),
(171, 139, 'Iris', 2),
(172, 139, 'Cutie Mark', 3),
(173, 139, 'Neckpiece', 0),
(174, 139, 'Flower', 0);
...
INSERT INTO `ponies` (`id`, `label`, `notes`, `cm_favme`, `added`) VALUES
(1, 'Applejack', '', NULL, '2015-09-21 18:46:54'),
(2, 'Fluttershy', '', NULL, '2015-09-21 18:54:47'),
(3, 'Pinkie Pie', 'Far legs use darker colors.', NULL, '2015-09-21 18:52:26'),
(4, 'Rainbow Dash', '', NULL, '2015-09-21 19:01:33'),
(5, 'Rarity', '', NULL, '2015-09-21 19:18:24'),
(6, 'Twilight Sparkle', 'Far legs use darker colors.', NULL, '2015-08-24 19:04:32'),
(7, 'Spike', '', NULL, '2015-09-21 19:43:59'),
(100, 'Minuette', 'For convenience, the color of the glass on her cutie mark is solid rather than transparent, thus the sand should be above.', NULL, '2015-07-25 14:49:44'),
(102, 'Derpy / Muffins', 'From S509 - Slice of Life', NULL, '2015-08-26 03:53:49'),
(103, 'Lyra Heartstrings', 'From S5E09 - Slice of Life', NULL, '2015-08-26 04:08:33'),
(104, 'Whoa Nelly', '', NULL, '2015-09-17 03:43:22'),
(105, 'Fashion Plate', '', NULL, '2015-09-17 04:02:26'),
(106, 'Sassy Saddles', 'From S5E14 Canterlot Boutique', NULL, '2015-09-17 04:22:20'),
(113, 'Twinkleshine', '', NULL, '2015-09-21 20:25:31'),
(114, 'Lemon Hearts', '', NULL, '2015-09-21 20:30:06'),
(115, 'Granny Smith', '', NULL, '2015-09-21 20:37:57'),
(116, 'Fleetfoot', '', NULL, '2015-09-21 20:58:56'),
(117, 'Stormy Flare', '', NULL, '2015-09-22 05:20:14'),
(118, 'Wind Rider', '', NULL, '2015-09-24 04:35:32'),
(119, 'Sugar Belle', '', NULL, '2015-09-24 10:44:18'),
(120, 'Apple Bloom', '', NULL, '2015-09-24 12:01:03'),
(121, 'Scootaloo', '', NULL, '2015-09-24 12:06:23'),
...
ALTER TABLE `colorgroups`
  MODIFY `groupid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;
ALTER TABLE `colors`
  MODIFY `colorid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=661;
ALTER TABLE `ponies`
