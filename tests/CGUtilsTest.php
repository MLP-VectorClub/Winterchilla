...
class CGUtilsTest extends TestCase {
	...
	public function testExpandEpisodeTagName(){
		...
		self::assertEquals('S08 E26', $result, 'Only parse seasons up to 8 and episodes up to 26');
		$result = CGUtils::expandEpisodeTagName('s9e26');
		self::assertEquals('s9e26', $result, 'Only parse seasons up to 8 and episodes up to 26');
		$result = CGUtils::expandEpisodeTagName('s8e27');
		self::assertEquals('s8e27', $result, 'Only parse seasons up to 8 and episodes up to 26');
		$result = CGUtils::expandEpisodeTagName('s99e99');
		self::assertEquals('s99e99', $result, 'Only parse seasons up to 8 and episodes up to 26');
