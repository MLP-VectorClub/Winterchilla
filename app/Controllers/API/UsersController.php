 ...
 *     type="boolean",
 *     description="If this value is true the DeviantArt access token expired and the backend is updating it in the background. Future requests
 *     should be made to the appropriate endpoint periodically to check whether the session update was successful and the user should be logged out
 *     if it wasn't."
 *   )
 * )
 */
