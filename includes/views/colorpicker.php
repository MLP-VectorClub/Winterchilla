...
<link rel="stylesheet" href="<?=\App\CoreUtils::cachedAsset('colorpicker','scss/min','css')?>">
...
<script src="<?=\App\CoreUtils::cachedAsset('jquery.ba-throttle-debounce','js/min','js')?>"></script>
<script src="<?=\App\CoreUtils::cachedAsset('shared-utils','js/min','js')?>"></script>
