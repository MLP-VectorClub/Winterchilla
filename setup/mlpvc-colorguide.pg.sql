...
SELECT pg_catalog.setval('colorgroups_groupid_seq', 431, true);
...
(60, 18, 'Outline/Inner Lines', '#132248', 0),
(61, 18, 'Fill', '#243870', 1),
...
(807, 211, 'Outline', '#A32141', 0),
(808, 211, 'Fill', '#E64A57', 1),
(809, 211, 'Shadow Outline', '#9E164C', 2),
(810, 211, 'Shadow Fill', '#D0335C', 3),
...
(1216, 313, 'Lightning Bolt', '#FFFFFF', 0),
...
(1412, 354, 'Teeth Outline', '#B0D8E7', 0),
(1413, 354, 'Mouth Fill', '#BD1C77', 1),
(1414, 354, 'Darker Mouth Fill', '#A41967', 2),
(1415, 354, 'Darkest Mouth Fill', '#841555', 3),
(1416, 354, 'Tongue', '#F17031', 4),
(1417, 354, 'Tongue Dark', '#BE4406', 5),
...
(1517, 379, 'Lens Fill (40% opaque)', '#FFFFFF', 2),
(1518, 379, 'Lens Highlight (33% opaque)', '#FFFFFF', 3),
(1519, 380, 'Outline', '#92D7F2', 0),
(1520, 380, 'Fill', '#BBFFFF', 1),
(1521, 380, 'Highlight', '#FBECF4', 2),
(1522, 381, 'Outline', '#DC6FB1', 0),
(1523, 381, 'Fill 1', '#C62D9B', 1),
(1524, 381, 'Fill 2', '#7EDE82', 2),
...
(1538, 386, 'Pupil', '#000000', 1),
(1539, 386, 'Shines', '#FFFFFF', 0),
(1540, 387, 'Fill (45% opacity)', '#AFC2CF', 0),
(1541, 387, 'Outline (45% opacity)', '#D9ECFB', 1),
(1542, 388, 'Outline', '#EACA79', 0),
(1543, 388, 'Fill', '#FCF8AC', 1),
(1544, 388, 'Shadow Outline', '#CF8D74', 2),
(1545, 388, 'Shadow Fill', '#DFAD96', 3),
(1548, 389, 'Outline', '#BEA2B0', 0),
(1549, 389, 'Fill', '#FFFFE2', 1),
(1551, 389, 'Shadow Fill', '#F5EEDC', 2),
(1552, 390, 'Outline', '#1F3E7D', 0),
(1553, 390, 'Fill 1', '#3167CC', 1),
(1554, 391, 'Gradient Top', '#580D36', 0),
(1556, 391, 'Gradient Bottom', '#BC1D75', 1),
(1557, 391, 'Highlight Top', '#D9539D', 2),
(1558, 391, 'Highlight Bottom', '#FCB6DF', 3),
(1559, 392, 'Beamed Quavers', '#000000', 0),
(1561, 393, 'Aura', '#CB4DB6', 0),
(1565, 396, 'Rim Outline', '#656565', 0),
(1566, 397, 'Ear Pad/Slider/Speaker Outline', '#A1A1A1', 8),
(1567, 396, 'Rim Fill', '#000000', 1),
(1568, 396, 'Lens Gradient Top', '#580C5E', 2),
(1569, 396, 'Lens Gradient Middle', '#9B2CA6', 3),
(1570, 396, 'Lens Gradient Bottom', '#E867CD', 4),
(1571, 396, 'Lens Highlight Gradient Top', '#A336BB', 5),
(1572, 397, 'Case/Headband Outline', '#09717A', 0),
(1573, 397, 'Case Fill 1/Headband Fill', '#01C7BA', 1),
(1574, 397, 'Case Shadow Fill', '#03A08E', 2),
(1575, 397, 'Case Highlight 1', '#00EAD8', 3),
(1576, 397, 'Case Fill 2', '#D7E7F3', 4),
(1577, 397, 'Case Highlight 2', '#EDF8FF', 5),
(1578, 397, 'Logo Fill', '#993499', 7),
(1579, 397, 'Logo Outline', '#FFFFFF', 6),
(1580, 397, 'Ear Pad/Slider Fill', '#FFFFFF', 9),
(1581, 397, 'Ear Pad/Slider Shadow Fill', '#C3C3C3', 10),
(1582, 396, 'Lens Highlight Gradient Bottom', '#E0A0F5', 6),
(1583, 398, 'Outline', '#336DBF', 0),
(1584, 398, 'Fill', '#3499C9', 1),
(1585, 398, 'Shadow Fill', '#3285C4', 3),
(1586, 398, 'Shadow Lightning Fill', '#A6BEAA', 4),
(1589, 400, 'Outer Frame Fill', '#4D4D4D', 0),
(1590, 400, 'Inner Frame Fill', '#313332', 1),
(1591, 400, 'Strap Fill', '#FDFE98', 2),
(1592, 400, 'Spitfire''s Strap Fill', '#FDFEBD', 3),
(1593, 400, 'Lens Outline', '#06B2D7', 4),
(1596, 400, 'Lens Fill', '#3BD0F5', 5),
(1597, 400, 'Lens Highlight 1', '#74DFF7', 6),
(1598, 400, 'Lens Highlight 2', '#D4F4FA', 7),
(1599, 398, 'Lightning Fill', '#FEFE98', 2),
(1600, 402, 'Outline', '#336DBF', 0),
(1601, 402, 'Fill', '#3499C9', 1),
(1602, 402, 'Yellow Fill', '#FEFE98', 2),
(1606, 404, 'Frame Fill 1', '#DBD678', 0),
(1607, 404, 'Frame Fill 2', '#8B792E', 1),
(1608, 404, 'Strap Fill', '#3E3B43', 2),
(1609, 404, 'Strap Inner Stroke', '#6B6775', 3),
(1613, 406, 'Outline', '#2D3558', 0),
(1614, 406, 'Fill', '#43558C', 1),
(1615, 406, 'Shadow Outline', '#233250', 2),
(1616, 406, 'Shadow Fill', '#3F5085', 3),
(1617, 390, 'Fill 2', '#05ECE6', 2),
(1618, 407, 'Outline', '#AAA48B', 0),
(1619, 407, 'Fill', '#FCF5DB', 1),
(1620, 407, 'Shadow Outline', '#928B76', 2),
(1621, 407, 'Shadow Fill', '#D6CFBA', 3),
(1622, 408, 'Outline', '#AE7444', 0),
(1623, 408, 'Fill 1', '#D7B069', 1),
(1624, 409, 'Gradient Top', '#2F9504', 0),
(1626, 409, 'Gradient Bottom', '#E1F98D', 1),
(1627, 409, 'Highlight Top', '#D6F473', 2),
(1628, 409, 'Highlight Bottom', '#EDFBC9', 3),
(1629, 410, 'Cookie Fill', '#D0AE66', 0),
(1630, 410, 'Chocolate Fill', '#7E5B25', 1),
(1631, 408, 'Fill 2', '#EEDA96', 2),
(1632, 411, 'Outline', '#4E939A', 0),
(1633, 411, 'Fill', '#9AE2E6', 1),
(1634, 411, 'Shadow Outline', '#45848A', 2),
(1635, 411, 'Shadow Fill', '#89CACD', 3),
(1636, 412, 'Outline', '#401009', 0),
(1637, 412, 'Fill 1', '#4A150D', 1),
(1638, 413, 'Gradient Top', '#743913', 0),
(1639, 413, 'Gradient Middle', '#CA8D6A', 1),
(1640, 413, 'Gradient Bottom', '#EDB696', 2),
(1641, 413, 'Highlight Top', '#EBD2A9', 3),
(1642, 413, 'Highlight Bottom', '#FFFFFF', 4),
(1643, 414, 'Color 1', '#F1BA47', 0),
(1644, 414, 'Color 2', '#FCE36D', 1),
(1645, 412, 'Fill 2', '#631D15', 2),
(1646, 415, 'Spoon Fill', '#D2FFF9', 0),
(1647, 415, 'Spoon Outline', '#9AD7EA', 1),
(1648, 415, 'Heart Fill', '#EA77D4', 2),
(1649, 415, 'Heart Highlight', '#FFE9FF', 3),
(1650, 416, 'Outline', '#ED99D2', 0),
(1651, 416, 'Fill', '#FDC3FC', 1),
(1653, 416, 'Shadow Fill', '#F8B2EB', 2),
(1654, 417, 'Outline', '#966FB8', 0),
(1655, 417, 'Fill 1', '#BB99DC', 1),
(1656, 418, 'Gradient Top', '#235EAA', 0),
(1657, 418, 'Gradient Middle', '#63A9DD', 1),
(1658, 418, 'Gradient Bottom', '#A4EEF2', 2),
(1659, 418, 'Highlight Top', '#A3C5E0', 3),
(1660, 418, 'Highlight Bottom', '#FFFFFF', 4),
(1661, 419, 'Tiara', '#718ABF', 0),
(1663, 417, 'Fill 2', '#FFFFFF', 2),
(1664, 420, 'Color 1', '#94A6D0', 0),
(1665, 420, 'Color 2', '#BFC9E2', 1),
(1666, 421, 'Outline', '#FA99CA', 0),
(1667, 421, 'Fill', '#FCCBE4', 1),
(1668, 421, 'Shadow Outline', '#E189B5', 2),
(1669, 421, 'Shadow Fill', '#E3B6CC', 3),
(1670, 422, 'Outline', '#8034BA', 0),
(1671, 422, 'Purple Gradient Dark', '#732DA2', 1),
(1672, 423, 'Gradient Top', '#532075', 0),
(1674, 423, 'Gradient Bottom', '#C181DA', 1),
(1675, 423, 'Highlight Top', '#BF94DE', 2),
(1676, 423, 'Highlight Bottom', '#DEC9EE', 3),
(1677, 424, 'Gem Fill 1', '#80CCDA', 0),
(1678, 424, 'Gem Fill 2', '#8DFFFD', 1),
(1679, 421, 'Wing Stroke Gradient Tip', '#A761F4', 4),
(1680, 421, 'Wing Fill Gradient Tip', '#C697F4', 5),
(1681, 422, 'Purple Gradient Light', '#C6A1E1', 2),
(1682, 422, 'Red Gradient Dark', '#D03092', 3),
(1683, 422, 'Red Gradient Light', '#FAC6E1', 4),
(1684, 422, 'Yellow Gradient Dark', '#F4E9A8', 5),
(1685, 422, 'Yellow Gradient Light', '#FAF8E1', 6),
(1686, 422, 'Forehead Mane Stroke Gr. Light', '#66288E', 7),
(1687, 422, 'Forehead Mane Stroke Gr. Dark', '#652891', 8),
(1688, 425, 'Outline', '#D3A82E', 0),
(1689, 425, 'Fill', '#FAE37D', 1),
(1690, 425, 'Jewel/Gem Outline', '#653C76', 2),
(1691, 425, 'Top Jewel Fill 1', '#DB9EE0', 3),
(1692, 425, 'Top Jewel Fill 2', '#995DB1', 4),
(1693, 425, 'Gem Fill 1', '#DEB0EE', 5),
(1694, 425, 'Gem Fill 2', '#B863C4', 6),
(1695, 425, 'Gem Fill 3', '#8541A9', 7),
(1696, 425, 'Shadow Outline', '#BD9932', 8),
(1697, 425, 'Shadow Fill', '#DFCB6E', 9),
(1698, 424, 'Gem Fill 3', '#50C9E4', 2),
(1699, 424, 'Gem Fill 4', '#24BAD2', 3),
(1700, 424, 'Adornments', '#E4C137', 4),
(1701, 426, 'Outline', '#B9A369', 0),
(1702, 426, 'Fill', '#DECB9B', 1),
(1704, 426, 'Shadow Fill', '#CFB882', 2),
(1705, 427, 'Outline', '#BABDBA', 0),
(1706, 427, 'Fill 1', '#E2E7E3', 1),
(1707, 428, 'Gradient Top', NULL, NULL),
(1708, 428, 'Gradient Middle', NULL, NULL),
(1709, 428, 'Gradient Bottom', NULL, NULL),
(1710, 428, 'Highlight Top', NULL, NULL),
(1711, 428, 'Highlight Bottom', NULL, NULL),
(1712, 429, 'Ribbon', '#3A69AA', 0),
(1713, 429, 'Scroll Main Fill 1', '#F5EDA8', 1),
(1714, 427, 'Fill 2', '#D0D5D2', 2),
(1715, 430, 'Collar Outline', '#979797', 0),
(1716, 430, 'Collar Fill', '#FEFEFE', 1),
(1717, 430, 'Collar Shadow Fill', '#D0D5D0', 2),
(1718, 430, 'Cravet Outline', '#007D7D', 3),
(1719, 430, 'Cravet Fill', '#009999', 4),
(1720, 431, 'Frame Outline', '#C7B420', 0),
(1721, 431, 'Frame Fill', '#EEE569', 1),
(1722, 429, 'Scroll Main Fill 2', '#E0D092', 2),
(1723, 429, 'Scroll Shadow Fill 1', '#C1AE78', 3),
(1724, 429, 'Scroll Shadow Fill 2', '#B49E63', 4);
...
SELECT pg_catalog.setval('colors_colorid_seq', 1724, true);
