			...
			$instr = $.mk('div').html(
				`<div class='hidden section ai'>
					...
					<ul>
						...
						<li>Once you have the script, <a href="/cg/v/${appearanceID}s.json" class="btn blue typcn typcn-download">click here</a> to download the <code>.json</code> file that you'll need to use for the import.</li>
				...
				<div class='hidden section inkscape'>
					...
					<p>Download <a href='/cg/v/${appearanceID}s.gpl' class='btn blue typcn typcn-download'>this file</a> and place it in the <code>&hellip;\\Inkscape<wbr>\\<wbr>share<wbr>\\<wbr>palettes</code> folder. If you don’t plan on using the other swatches, deleting them should make your newly imported swatch easier to find.</p>
